...
\begin{document}
	...
	\begin{frame}{Pooling Type}
		\begin{itemize}
			\item Max Pooling works well \textbf{when the background is dark}, and the object is light.
			\item Min Pooling works well \textbf{when the background is light}, and the object is dark.
